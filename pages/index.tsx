  ...
  return (
    ...
    >
      ...
      <header className="flex justify-between w-full px-12 py-8">
        ...
        <div>
          {!session ? (
            <button className="flex items-center bg-[#e50914] text-white text-sm px-4 py-2 rounded">
              Sign In
            </button>
          ) : (
            <button className="flex items-center bg-[#e50914] text-white text-sm px-4 py-2 rounded">
      ...
      <main className="flex flex-col items-center pt-20 flex-1 px-20 text-center">
        <h1 className="text-2xl md:text-5xl font-bold text-white max-w-lg tracking-wide">
          Unlimited movies, TV shows, and more.
        </h1>
        <h2 className="text-1xl md:text-2xl text-white mt-4 mb-8">
          Watch anywhere. Cancel anytime.
        </h2>
        <p className="text-white text-lg max-w-xs md:max-w-max">
          Ready to watch? Enter your email to create or restart your membership.
        </p>
        <div className="flex mt-4 flex-col space-y-4 items-center md:flex-row md:space-y-0">
          <input
            placeholder="Email address"
            className="bg-white p-4 min-w-[400px] m-auto"
          />
          <button className="flex items-center bg-[#e50914] text-white text-lg max-w-[200px] p-4 md:px-8">
            Get Started
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
